          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="dark:bg-dark mx-auto max-w-[500px] rounded bg-white px-6 py-10 shadow-three sm:p-[60px]">
                ...
                <button className="dark:text-body-color-dark dark:shadow-two dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none mb-6 flex w-full items-center justify-center rounded-sm border border-stroke bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary">
                  <span className="mr-3">
                    <svg
                      width="20"
                      height="20"
                ...
                <form onSubmit={onSubmit}>
                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            className="sr-only"
                          />
                          <div className="box dark:border-white dark:border-opacity-10 mr-4 flex h-5 w-5 items-center justify-center rounded border border-body-color border-opacity-20">
                  ...
                  <div className="mb-6">
                    <button className="dark:shadow-submit-dark flex w-full items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90">
                      Sign in
                    </button>
                  </div>
                </form>
